    ...
    */
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*onCancel*/ ctx[6]);
    				mounted = true;
    			}
    		},
    		p: noop$1,
    ...
    function create_each_block(ctx) {
    	...
    	return {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(button0, "click", function () {
    						if (is_function(/*deleteTask*/ ctx[4](/*task*/ ctx[2].id))) /*deleteTask*/ ctx[4](/*task*/ ctx[2].id).apply(this, arguments);
    					}),
    					listen(button1, "click", function () {
    						if (is_function(/*editTask*/ ctx[5](/*task*/ ctx[2]))) /*editTask*/ ctx[5](/*task*/ ctx[2]).apply(this, arguments);
    					})
    				];
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*tasks*/ 1 && t0_value !== (t0_value = /*task*/ ctx[2].name + "")) set_data(t0, t0_value);
    			if (dirty & /*tasks*/ 1 && t2_value !== (t2_value = /*task*/ ctx[2].description + "")) set_data(t2, t2_value);
    		},
    		d(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (!/*editStatus*/ ctx[1]) return create_if_block_1;
    		return create_else_block;
    	}

    	let current_block_type = select_block_type(ctx);
    	let if_block0 = current_block_type(ctx);
    	let if_block1 = /*editStatus*/ ctx[1] && create_if_block(ctx);
    	...
    	return {
    		c() {
    			...
    			attr(input, "placeholder", "Write a new task");
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*editTask, tasks, deleteTask*/ 49) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const handleSubmit = () => {
    		...
    		$$invalidate(2, task = { name: "", description: "" });
    	};
    	...
    	db.collection("tasks").onSnapshot(querySnapshot => {
    		...
    		$$invalidate(0, tasks = [...docs]);
    		console.log(tasks);
    	});

    	const addTask = async () => {
    		await db.collection("tasks").doc().set({ ...task, createdAt: Date.now() });
    	};
    	...
    	const editTask = currentTask => {
    		...
    		$$invalidate(2, task.name = currentTask.name, task);
    		$$invalidate(2, task.description = currentTask.description, task);
